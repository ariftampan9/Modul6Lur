...
public class TampilMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showEmployee(String json){
        try {
            ...
            String jurusan = c.getString(konfigurasi.TAG_POSISI);
            String email = c.getString(konfigurasi.TAG_GAJIH);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_POSISI,jurusan);
                hashMap.put(konfigurasi.KEY_EMP_GAJIH,email);
